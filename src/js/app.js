...
// Verificar si el elemento con el ID 'verificarBoton2' existe antes de agregar un evento
const verificarBoton8 = document.getElementById('verificarBoton8');
if (verificarBoton8) {
  verificarBoton8.addEventListener('click', verificarContenido8);
}

// Verificar si el elemento con el ID 'verificarBoton2' existe antes de agregar un evento
const verificarBoton9 = document.getElementById('verificarBoton9');
if (verificarBoton9) {
...
// Verificar si el elemento con el ID 'verificarBoton2' existe antes de agregar un evento
const verificarBoton11 = document.getElementById('verificarBoton11');
if (verificarBoton11) {
  verificarBoton11.addEventListener('click', verificarContenido11);
}
